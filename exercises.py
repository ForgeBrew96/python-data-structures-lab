...
def manage_students():
    students = ['chris', 'bob', 'other student']
...
home_town['color'] = 'white, red and blue'
city = home_town['city']
state = home_town['state']
population = home_town['population']

def hometown_info():
    home_town_message = f'I was born in {city}, {state} - population of {population}'
